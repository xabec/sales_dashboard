...
class OrdersChartTotals extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        return Chartisan::build()
            ...
            ->dataset('Orders', [round($dataset->sum('orders'))])
            ->dataset("Orders {$daysRangeChosen} days ago",  [0, round(array_sum($ordersBefore))]);
    }
}
