...
class RevenueChartTotals extends BaseChart
{
    /**
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        return Chartisan::build()
            ...
            ->dataset('Revenue', [round($dataset->sum('total'), 2)])
            ->dataset("Revenue {$daysRangeChosen} days ago",  [0, round(array_sum($revenueBefore), 2)]);
    }
}
