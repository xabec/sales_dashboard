                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li  class="nav-item {{ request()->is('items') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('items.index') }}">Top Items</a>
                        </li>

                        <li  class="nav-item {{ request()->is('customers') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('customers.index') }}">Top Customers</a>
                        </li>

                        <li  class="nav-item {{ request()->is('upload') ? 'active' : '' }}">
                            <a class="nav-link text-danger" href="{{ route('upload.index') }}">Upload</a>
                        </li>
                    </ul>
